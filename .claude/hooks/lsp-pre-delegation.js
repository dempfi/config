...
process.stdin.on('end', () => {
  ...
  console.log(JSON.stringify({
    ...
    reason: [
      ...
      '',
      'DO THIS NOW (2 steps, then retry the Agent call):',
      '1. mcp__plugin_serena_serena__find_symbol("<keyword from task>")  — finds symbol by name',
      '2. Add to EVERY agent prompt:',
